...
cap = cv2.VideoCapture('video_input_2.mp4')
...
while (True):
    ...
    if ret:
        ...
        circles = cv2.HoughCircles(blurImg, cv2.HOUGH_GRADIENT, 1, 100, param1=100, param2=40)
        #circles = cv.HoughCircles(blurFrame, cv.HOUGH_GRADIENT, 0.8, 100,
